...
# "Личность" бармена — живой, с юмором, но без пошлости
...
async def get_cocktail_recipe(user_message: str, mode: str = "basic") -> str:
    """Отправляет запрос к OpenRouter (бесплатная нейросеть) и возвращает рецепт"""
    url = "https://openrouter.ai/api/v1/chat/completions"

    headers = {
        "Authorization": f"Bearer {settings.OPENROUTER_API_KEY}",
        "Content-Type": "application/json",
        "HTTP-Referer": "https://t.me/CocktailGeniusMagBot",  # Замени на свой
        "X-Title": "GPT-BarmanBot"
    }

    # Уточняем запрос в зависимости от режима
    if mode == "from_bar":
    ...
    payload = {
        ...
        "temperature": 0.9,  # Чуть больше творчества
        "max_tokens": 800
    }
